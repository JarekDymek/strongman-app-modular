...
function setupEventListeners() {
    ...
    // --- Intro Screen ---
    document.getElementById('startCompetitionBtn').addEventListener('click', () => Handlers.handleStartCompetition(refreshFullUI));
    ...
    // --- Main Screen Actions ---
    document.getElementById('shuffleBtn').addEventListener('click', Handlers.handleShuffle);
    document.getElementById('showResultsBtn').addEventListener('click', UI.toggleHistoryPanel);
    document.getElementById('nextEventBtn').addEventListener('click', Handlers.handleNextEvent);
    document.getElementById('finalEventBtn').addEventListener('click', Handlers.handleFinalEvent);
    ...
    document.getElementById('resultsTable').addEventListener('input', (e) => {
