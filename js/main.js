...
import * as Database from './database.js'; // <-- Zmieniono import
...
async function initializeApp() {
    // Definicja funkcji odświeżającej w głównym zakresie, aby była dostępna dla listenerów
    const refreshFullUI = () => {
    ...
    try {
        ...
        // --- POPRAWKA: Inicjalizacja jednej, centralnej bazy danych ---
